...
void ModuleModel::LogInfo(const std::string& pMessage)
{
...
void ModuleModel::LogError(const std::string& pMessage)
{
...
std::vector<Texture> ModuleModel::loadTextures(aiMaterial* mat, aiTextureType type, char* typeName)
{
...
void ModuleModel::UpdateTexture(Texture& textToUpdate)
{
...
bool ModuleModel::FileExists(const char* path)
{
	if (access(path, 0) == -1)
	{
